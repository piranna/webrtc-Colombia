...
(function(process) {
  ...
  var prebuildClientVersion = require('./package.json!systemjs-json').version;
  if (rc.version) {
  ...
  if (util.isYarnPath(execPath) && /node_modules/.test(process.cwd())) {} else if (!(typeof pkg._from === 'string')) {
